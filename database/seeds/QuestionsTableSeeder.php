...
class QuestionsTableSeeder extends Seeder
{
    ...
    public function run()
    {
        ...
        DB::table('questions')->insert([
            'title' => 'Lösen Sie folgende Differentialgleichung',
        ...
        DB::table('questions')->insert([
            'title' => 'Was ist die Laplace-Transformierte der Funktion?',
        ...
        DB::table('questions')->insert([
            'title' => 'Wie lautet der Entwicklungspunkt?',
        ...
        DB::table('questions')->insert([
            'title' => 'Berechnen Sie den Konvergenzradius',
        ...
        DB::table('questions')->insert([
            'title' => 'Berechnen Sie den Wert der Fourierreihe',
        ...
        DB::table('questions')->insert([
            'title' => 'Welchen Wert besitzt der Rourierkoeffizient?',
        ...
        DB::table('questions')->insert([
            'title' => 'Wie groß ist die Steigung im Punkt..?',
        ...
        DB::table('questions')->insert([
            'title' => 'Welche der folgenden Aussagen über lokale Extremwerte ist richtig?',
